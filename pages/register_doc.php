            ...
            <div class="row mt-1">
              ...
              <div class="col-3">
                <div class="form-group">
                  ...
                  <input type='text' class='form-control datepicker-here' data-language='en' data-date-format='dd-mm-yyyy' id="MFGDate">
                </div>
              </div>
            ...
            <div class="row  mt-1">
              ...
              <div class="col-3">
                <div class="form-group">
                  ...
                  <input type='text' class='form-control  datepicker-here' data-language='en' data-date-format='dd-mm-yyyy' id="ExpireDate">
                </div>
              </div>
