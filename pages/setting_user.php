	...
	<link rel="stylesheet" href="assets/css/demo.css">
            ...
            <div class="row">
                    ...
                    <table id="Data_TableLeft" class="table table-bordered table-hover w-100 table-head-fixed">
                      <thead>
                        <tr class="text-center">
                          ...
                          <th style="width: 80%;" class="bg_tableAll">User</th>
                        </tr>
                      </thead>
                      <tbody>
              ...
              <div class="col-8">
                ...
                <div class="col-3">
                  <input type="text" class="form-control" id="txtSearch" onkeyup="showData_User();" placeholder="ค้นหารายการ">
                </div>
                    ...
                    <table id="Data_TableRight" class="table table-bordered table-hover w-100 table-head-fixed">
                      <thead>
                        <tr class="text-center">
                          ...
                          <th style="width: 90%;" class="bg_tableAll">สิทธิ์การเข้าถึงเมนู
</th>
                        </tr>
                      </thead>
                      <tbody>
