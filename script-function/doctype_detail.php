<script>
  ...
  function saveData() {
    var txt_doctype_detail_name= $('#txt_doctype_detail_name').val();
    


    var text = "";

    if (txt_doctype_detail_name == "") {
    ...
    $.ajax({
      ...
      data: {
        'FUNC_NAME': 'saveData',
        'txt_doctype_detail_name': txt_doctype_detail_name
      },
      success: function(result) {
        if(result=="0"){
          showDialogFailed("ประเภทเอกสารซ้ำ กรุณากรอกประเภทใหม่อีกครั้ง");
        }else{
